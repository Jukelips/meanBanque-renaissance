...
var MouvementEditComponent = /** @class */ (function () {
    function MouvementEditComponent(mouvementService, router, alertService, route) {
    ...
    MouvementEditComponent.prototype.getMouvement = function (id) {
        var _this = this;
        this.mouvementService.getMouvementById(id).subscribe(function (mouvement) { _this.model = mouvement; });
    };
    MouvementEditComponent.prototype.updateMouvement = function () {
        var _this = this;
        this.loading = true;
        this.mouvementService.update(this.model)
            .subscribe(function (data) {
            _this.alertService.success('Modification du mouvement réussie', true);
    ...
    MouvementEditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [index_1.MouvementService, router_1.Router, index_1.AlertService, router_1.ActivatedRoute])
